...
- (void)sw_addUtilityButtonWithSpecial:(BOOL)isSpecial normalIcon:(NSString *)normalIconName selectedIcon:(NSString *)selectedIconName enabled:(BOOL)enabled {
    UIImage *normalIcon, *selectedIcon;
//    UIColor *color;
    normalIcon = [UIImage imageNamed:normalIconName];
    selectedIcon = [UIImage imageNamed:selectedIconName];
    ...
    button.accessibilityElementsHidden = enabled;
    [self addObject:button];
}
